...
function TourTooltip({ tooltipProps, primaryProps, step, index, size }: TooltipRenderProps) {
  return (
    <Card {...tooltipProps} id="tour-tooltip" className="z-50 w-[320px] overflow-hidden rounded-xl border-none">
      ...
      <Hide
        ...
        component={
          <CardFooter className="flex justify-end border-t border-white/10 pb-4 pt-4">
            <Button {...primaryProps} id="tour-tooltip-next-button" className="px-6 transition-colors duration-300">
              다음
            </Button>
          </CardFooter>
        }
